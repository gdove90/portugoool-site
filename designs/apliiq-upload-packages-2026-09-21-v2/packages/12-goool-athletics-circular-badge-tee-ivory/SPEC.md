...
# GOOOL Athletics Circular Badge Tee — Ivory

**Revision 2: local artwork and placement package prepared; supplier proof/sample not approved.**

Blank: Comfort Colors C1717. Exact supplier color candidate: Ivory. Sizes: S, M, L, XL, XXL.

Recorded design ID: 6112033. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 3.000 x 3.032 | 3.000: top of visible artwork below bottom front collar seam | artwork center 3.5in wearer-left of body centerline (viewer right) | [GA-CIRCLE-08-NAVY-PRINT.svg](artwork/GA-CIRCLE-08-NAVY-PRINT.svg) |
