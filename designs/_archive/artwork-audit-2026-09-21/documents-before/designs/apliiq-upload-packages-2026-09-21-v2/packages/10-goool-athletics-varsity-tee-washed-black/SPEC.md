# GOOOL Athletics Varsity Tee — Washed Black

**Revision 2: local artwork and placement package prepared; supplier proof/sample not approved.**

Blank: Bella+Canvas 4810GD. Exact supplier color candidate: Washed Black. Sizes: S, M, L, XL, XXL.

Recorded design ID: 6112032. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 11.000 x 5.280 | 3.000: top of visible artwork below bottom collar seam | body centerline | [GA-02-F_3300px.png](artwork/GA-02-F_3300px.png) |
| back | 3.250 x 1.557 | 2.000: top of visible artwork below bottom collar seam | body centerline | [GA-02-B_975px.png](artwork/GA-02-B_975px.png) |
...
- Confirm reconstructed/distressed artwork and negative-space treatment in production proof.
