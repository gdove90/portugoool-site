...
Blank: Sport-Tek ST720. Exact supplier color candidate: White. Sizes: S, M, L, XL, XXL.

Recorded design ID: 6099046. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 5.000 x 6.400 | 2.250: top of visible artwork below bottom collar seam | body centerline | [GOOOL_ALT_01_ST720_BADGE_NAVY_BURGUNDY_FRONT_5IN.png](artwork/GOOOL_ALT_01_ST720_BADGE_NAVY_BURGUNDY_FRONT_5IN.png) |
