...
Blank: Bella+Canvas 3010. Exact supplier color candidate: Black. Sizes: S, M, L, XL, XXL.

Recorded design ID: 6112026. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 11.000 x 3.680 | 3.000: top of visible artwork below bottom collar seam | body centerline | [GA-01-F_3300px_CLEAN.png](artwork/GA-01-F_3300px_CLEAN.png) |
