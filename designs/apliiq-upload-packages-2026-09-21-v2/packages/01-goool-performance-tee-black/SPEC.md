...
Recorded design ID: 6098962. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 5.000 x 6.400 | 2.250: top of visible artwork below bottom collar seam | body centerline | [GOOOL_SAMPLE_01_ST720_BADGE_FRONT_5IN.png](artwork/GOOOL_SAMPLE_01_ST720_BADGE_FRONT_5IN.png) |
