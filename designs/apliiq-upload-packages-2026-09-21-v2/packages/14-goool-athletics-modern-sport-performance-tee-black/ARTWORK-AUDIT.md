# Artwork authority addendum — 2026-09-21
...
- Keep the original print source. A newer SVG or 600ppi PNG is not automatically a higher-quality master. Circular SVGs are alpha>=128 pixel-run traces of the original 1254px raster. Their effective source resolution is308ppi at3in width or369.6ppi at2.5in; exports do not add detail.
...
- Current roster10 products/14 colorways. Closest Apliiq color on the same blank is authorized; record exact offered color and swatch. AS Colour 5150 Athletic Heather is a candidate, not a verified swatch in this audit.
