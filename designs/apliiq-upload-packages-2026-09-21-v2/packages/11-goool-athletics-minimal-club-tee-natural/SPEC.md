...
# GOOOL Athletics Minimal Club Tee — Natural

**Revision 2: local artwork and placement package prepared; supplier proof/sample not approved.**

Blank: Bella+Canvas 3010. Exact supplier color candidate: Natural. Sizes: S, M, L, XL, XXL.

Recorded design ID: 6112018. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 3.500 x 1.103 | 3.000: top of visible artwork below bottom collar seam | artwork CENTER 3.5in wearer-left of body centerline (viewer right) | [GA-03-F_1050px.png](artwork/GA-03-F_1050px.png) |
| back | 12.000 x 4.630 | 2.750: top of visible artwork below bottom collar seam | body centerline | [GA-03-B_3600px.png](artwork/GA-03-B_3600px.png) |
