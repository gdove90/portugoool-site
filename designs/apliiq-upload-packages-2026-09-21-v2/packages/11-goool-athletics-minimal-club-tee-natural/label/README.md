> **Layout status:** This flat file is a later composition candidate. Compare it to the owner-approved tag concept at actual size; it is not an exact recovered original vector. See [ARTWORK-AUDIT.md](../ARTWORK-AUDIT.md).

# Flat GOOOL ATHLETICS brand-label artwork — revision 2
