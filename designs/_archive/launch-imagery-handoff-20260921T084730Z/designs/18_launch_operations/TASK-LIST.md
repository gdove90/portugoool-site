...
Current order: Stripe/payment infrastructure → verified costs/prices → production readiness → Instagram launch. Work on Instagram drafts while account/supplier steps are pending. The owner requires prices to stay unpublished until costs are verified.
...
- **ART-01:** Apply existing prompt to6098963/6099060; front visible top3in below bottom collar seam, width6.75in unchanged. Reopen proof; update both colors and front model/gallery images.
