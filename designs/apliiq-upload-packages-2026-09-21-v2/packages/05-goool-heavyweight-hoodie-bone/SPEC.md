...
# GOOOL Core Hoodie — Bone

**Revision 2: local artwork and placement package prepared; supplier proof/sample not approved.**

Blank: Independent Trading Co. IND4000. Exact supplier color candidate: Bone. Sizes: S, M, L, XL, XXL.

Recorded design ID: 6099064. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 6.750 x 2.343 | 4.000: top of visible artwork below hood/neck seam | body centerline | [GOOOL_ALT_02_WORDMARK_NAVY_BURGUNDY_FRONT_6.75IN.png](artwork/GOOOL_ALT_02_WORDMARK_NAVY_BURGUNDY_FRONT_6.75IN.png) |
