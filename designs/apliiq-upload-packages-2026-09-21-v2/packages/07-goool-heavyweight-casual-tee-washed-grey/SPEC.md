> **Owner placement update:** front artwork top is now **3.00in below the bottom collar seam**, width remains **6.75in**. See [the revision](CASUAL-TEE-PLACEMENT-REVISION.md). Apliiq and website changes remain pending.
...
Blank: Bella+Canvas 4810GD. Exact supplier color candidate: Washed Grey. Sizes: S, M, L, XL, XXL.

Recorded design ID: 6099060. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 6.750 x 2.343 | 3.000: top of visible artwork below bottom collar seam | body centerline | [GOOOL_ALT_02_WORDMARK_NAVY_BURGUNDY_FRONT_6.75IN.png](artwork/GOOOL_ALT_02_WORDMARK_NAVY_BURGUNDY_FRONT_6.75IN.png) |
