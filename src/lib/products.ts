...
export const products: Product[] = [
  ...
  // ── Crest V2 T-Shirt Line (AA 1301GD, Printful DTF) ─────────
  {
    ...
    name: "GOOOL Crest Tee — Cream",
    slug: "crest-tee-cream",
    description:
      "The crest, quiet, where it belongs. Heavyweight garment-dyed cotton.",
    priceCents: 3300,
    compareAtPriceCents: null,
    color: "Faded Cream",
    colorHex: "#FFF9E9",
    ...
    careInstructions: CASUAL_CARE,
    images: [
      { src: "/products/crest-tee-cream.webp", alt: "GOOOL Crest Tee — Cream — front" },
      { src: "/products/crest-tee-cream-back.webp", alt: "GOOOL Crest Tee — Cream — back" },
    ],
    sizes: SHIRT_SIZES,
    category: "tshirt",
    supplierType: "printful",
  ...
  },
  {
    ...
    name: "GOOOL Crest Tee — Faded Black",
    slug: "crest-tee-faded-black",
    description:
      "Faded black, crest over the heart. The pair that anchors the line.",
    priceCents: 3300,
    compareAtPriceCents: null,
    color: "Faded Black",
    colorHex: "#55565A",
    ...
    careInstructions: CASUAL_CARE,
    images: [
      { src: "/products/crest-tee-faded-black.webp", alt: "GOOOL Crest Tee — Faded Black — front" },
      { src: "/products/crest-tee-faded-black-back.webp", alt: "GOOOL Crest Tee — Faded Black — back" },
    ],
    sizes: SHIRT_SIZES,
    category: "tshirt",
    supplierType: "printful",
  ...
  },
  {
    ...
    description:
      "The crest at full volume. Center chest, seven and a half inches of it.",
    priceCents: 3500,
    compareAtPriceCents: null,
    color: "Faded Cream",
    colorHex: "#FFF9E9",
  ...
  },
  {
    ...
    name: "GOOOL Full-Back Crest Tee — Faded Black",
    slug: "crest-fullback-tee-faded-black",
    description:
      "Full-back crest. The shirt that keeps talking when you walk away.",
    priceCents: 3800,
    compareAtPriceCents: null,
    color: "Faded Black",
    colorHex: "#55565A",
    ...
    careInstructions: CASUAL_CARE,
    images: [
      { src: "/products/crest-fullback-tee-faded-black.webp", alt: "GOOOL Full-Back Crest Tee — Faded Black — front" },
      { src: "/products/crest-fullback-tee-faded-black-back.webp", alt: "GOOOL Full-Back Crest Tee — Faded Black — back" },
    ],
    sizes: SHIRT_SIZES,
    category: "tshirt",
    supplierType: "printful",
  ...
  },
  {
    ...
    name: "GOOOL Crest Tee — Faded Navy (Center Front)",
    slug: "crest-centerfront-tee-faded-navy",
    description:
      "Nine inches of crest, front and center. For the loudest rooms.",
    priceCents: 3500,
    compareAtPriceCents: null,
    color: "Faded Navy",
    colorHex: "#4F5C71",
    ...
    careInstructions: CASUAL_CARE,
    images: [
      { src: "/products/crest-centerfront-tee-faded-navy.webp", alt: "GOOOL Crest Tee — Faded Navy (Center Front) — front" },
      { src: "/products/crest-centerfront-tee-faded-navy-back.webp", alt: "GOOOL Crest Tee — Faded Navy (Center Front) — back" },
    ],
    sizes: SHIRT_SIZES,
    category: "tshirt",
    supplierType: "printful",
  ...
  },
  {
    ...
    name: "GOOOL Crest Tee — Faded Navy",
    slug: "crest-tee-faded-navy",
    description:
      "Faded navy, crest at the heart. Match-day calm before the noise.",
    priceCents: 3300,
    compareAtPriceCents: null,
    color: "Faded Navy",
    colorHex: "#4F5C71",
    ...
    careInstructions: CASUAL_CARE,
    images: [
      { src: "/products/crest-tee-faded-navy.webp", alt: "GOOOL Crest Tee — Faded Navy — front" },
      { src: "/products/crest-tee-faded-navy-back.webp", alt: "GOOOL Crest Tee — Faded Navy — back" },
    ],
    sizes: SHIRT_SIZES,
    category: "tshirt",
    supplierType: "printful",
