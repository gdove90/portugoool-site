...
2. [All 64 catalog products](ALL-PRODUCTS.md): 10 active /54 inactive; source files, package links and missing work.
3. [Current 14 Apliiq packages](../apliiq-upload-packages-2026-09-21-v2/START-HERE.md): each package/ZIP carries the audit addendum.
