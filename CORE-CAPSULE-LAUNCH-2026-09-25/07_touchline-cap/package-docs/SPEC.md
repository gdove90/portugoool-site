...
# GOOOL Touchline Cap — Black/Natural

**Revision 2: local artwork and placement package prepared; supplier proof/sample not approved.**

Blank: OTTO 31-069. Exact supplier color candidate: Black/Natural. Sizes: OS.

Recorded design ID: 6098980. Reopen and verify it; do not assume old records include the new label.
...
|---|---|---|---|---|
| front | 3.750 x 1.303 | 0.500: BOTTOM of visible embroidery ABOVE visor seam | front panel centerline | [GOOOL_SAMPLE_04_OTTO31069_WORDMARK_FRONT_EMBROIDERY_REFERENCE.png](reference-only/embroidery/GOOOL_SAMPLE_04_OTTO31069_WORDMARK_FRONT_EMBROIDERY_REFERENCE.png) |

Method: Flat embroidery, front only; no puff. Back: blank. Sleeves blank; cap sides/rear blank. Preserve aspect ratio and exact three-O spelling. Dimensions apply to visible artwork. Existing PNG transparent insets are recorded in spec.json; new circular artwork is tightly bounded.
...
- Supplier digitization and sew-out proof required; provided PNG/PDF are embroidery references, not machine stitch files.
